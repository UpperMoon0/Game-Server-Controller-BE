...
# Install bash, ca-certificates, postgresql-client, curl, and OpenJDK (required for Flyway)
RUN apk --no-cache add bash ca-certificates postgresql-client curl openjdk17-jre-headless
